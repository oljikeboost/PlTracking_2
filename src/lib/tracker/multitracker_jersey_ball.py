...
class STrack(BaseTrack):
    ...
    def __init__(self, tlwh, score, temp_feat, curr_jersey=None, ball_poss=None, buffer_size=90):
    ...
    def activate(self, kalman_filter, frame_id, jersey_num=None, ball_poss=None):
        ...
        self.ball_list.append(ball_poss)

    def re_activate(self, new_track, frame_id, new_id=False, jersey_num=None, ball_poss=None):
    ...
    def update(self, new_track, frame_id, jersey_num=None, ball_poss=None, update_feature=True):
        """
...
class JDETracker(object):
    ...
    def update(self, im_blob, img0):
        ...
        ball_feature = ball_feature[remain_inds]
