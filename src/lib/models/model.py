...
from .networks.pose_dla_dcn_recheck import get_pose_net as get_dla_dcn_recheck
from .networks.pose_dla_dcn_ccn import get_pose_net as get_dla_dcn_ccn
...
_model_factory = {
    ...
    'dla': get_dla_dcn,
    'dlarecheck': get_dla_dcn_recheck,
    'dlaccn': get_dla_dcn_ccn,
...
def create_model(arch, heads, head_conv, norm_eval):
